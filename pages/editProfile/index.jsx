    ...
    <>
      ...
      <>
        <div
          ...
          className="g-gray-200 w-full h-auto   bg-cover rounded-b-3xl"
        >
          <div className="bg-white w-full h-full bg-opacity-90 lg:pt-32 mb-20 lg:p-0 p-60 px-9  rounded-b-3xl">
