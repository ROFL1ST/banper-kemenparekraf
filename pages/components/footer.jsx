  ...
  return (
    <>
      ...
      <div className="mx-auto px-5 pb-5 pt-10 flex justify-center items-center rounded-b-lg bg-[#f5f5fa]">
        <a
          href="https://www.facebook.com/ParekrafRI"
          className="text-white rounded-full bg-[#142b51] p-2"
        >
          <svg
            fill="currentColor"
            strokeWidth="2"
        ...
        <a
          href="https://twitter.com/Kemenparekraf?s=20&t=hGqGbY2NV6nq9jraHzfnMQ"
          className="ml-3 text-white rounded-full bg-[#142b51] p-2"
        >
          <svg
            fill="currentColor"
            strokeLinecap="round"
