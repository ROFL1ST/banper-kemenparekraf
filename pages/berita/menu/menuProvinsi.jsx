      ...
      <div className="flex flex-col space-y-2 space-x-7">
        <div className={"cursor-pointer flex items-center space-x-1"}>
          <input
            ...
            required
            className="form-check-input rounded-sm appearance-none h-4 w-4 lg:h-3.5 lg:w-3.5 border border-gray-300 bg-white checked:bg-gray-600 checked:border-black focus:outline-none transition duration-200 align-top bg-no-repeat bg-center bg-contain float-left  cursor-pointer mr-3"
          />
          <div
